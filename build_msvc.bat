...
set CFLAGS=/W4 /WX /std:c11 /wd4996 /wd5105 /wd4244 /wd4267 /wd4702 /wd4200 /FC /TC /Zi /nologo
...
if not exist SDL2.dll copy dependencies\SDL2\lib\x64\SDL2.dll SDL2.dll
